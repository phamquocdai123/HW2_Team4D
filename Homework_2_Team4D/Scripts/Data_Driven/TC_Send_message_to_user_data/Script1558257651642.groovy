...
WebUI.click(findTestObject('Object Repository/Page_Spectrum community/div_Members'))

WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_Message'))

WebUI.setText(findTestObject('Object Repository/Page_Spectrum community/textarea_123dsas_style__Input-yy8ipz-4__input'), 
    message)

WebUI.click(findTestObject('Object Repository/Page_Spectrum community/button_Send'))

WebUI.click(findTestObject('Object Repository/Page_Spectrum community/svg_view-back'))
