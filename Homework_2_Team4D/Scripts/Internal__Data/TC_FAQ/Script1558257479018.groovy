...
WebUI.click(findTestObject('Object Repository/Page_My settings/a_Profile'))

WebUI.click(findTestObject('Page_Duy Trng  duy-tr-ng/button_Settings'))

WebUI.click(findTestObject('Object Repository/Page_My settings/a_Read more about how we delete accounts'))
