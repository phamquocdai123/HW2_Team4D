...
WebUI.click(findTestObject('Object Repository/Page_123dsas  123dsas/button_Settings'))

WebUI.click(findTestObject('Object Repository/Page_My settings/div_photo'))
