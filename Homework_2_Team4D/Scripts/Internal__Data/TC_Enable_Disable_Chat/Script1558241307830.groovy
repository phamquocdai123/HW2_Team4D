...
WebUI.click(findTestObject('Object Repository/Page_123 settings/img_Profile_style__Avatar-sc-1lxh6l2-8 jDmiKU'))

WebUI.click(findTestObject('Page_123 community/button_Settings'))

WebUI.click(findTestObject('Object Repository/Page_123 settings/button_Disable'))

WebUI.click(findTestObject('Object Repository/Page_123 settings/button_Enable'))

WebUI.doubleClick(findTestObject('Object Repository/Page_123 settings/button_Saving'))
