...
WebUI.click(findTestObject('Page_12312 community/button_Settings'))

WebUI.click(findTestObject('Object Repository/Page_123213 settings/button_Create Channel'))

WebUI.setText(findTestObject('Object Repository/Page_123213 settings/input_Channel Name_name'), '213123123')

WebUI.setText(findTestObject('Object Repository/Page_123213 settings/textarea_Describe it in 140 characters or less_slug'), 
    '312312')
