...
WebUI.click(findTestObject('Page_Spectrum/div_Create a usernameYou can change this at any time so no pressureThat username is availableSave and ContinueLog out'))
